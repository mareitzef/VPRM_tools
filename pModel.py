...
def pModel_subdaily(
    ...
    # if np.isnan(temp_subdaily).any():
    #     print("temp_subdaily has nan values")
    #     temp_subdaily = temp_subdaily.interpolate(limit=24).fillna(0)
    # if np.isnan(ppfd_subdaily).any():
    #     print("ppfd_subdaily has nan values")
    #     ppfd_subdaily = ppfd_subdaily.interpolate(limit=24).fillna(0)
    # if np.isnan(vpd_subdaily).any():
    #     print("vpd_subdaily has nan values")
    #     vpd_subdaily = vpd_subdaily.interpolate(limit=24).fillna(0)
    # if np.isnan(co2_subdaily).any():
    #     print("co2_subdaily has nan values")
    #     co2_subdaily = co2_subdaily.interpolate(limit=24).fillna(0)
    # if np.isnan(patm_subdaily).any():
    #     print("patm_subdaily has nan values")
    #     patm_subdaily = patm_subdaily.interpolate(limit=24).fillna(0)
    # if np.isnan(fpar_subdaily).any():
    #     print("fpar_subdaily has nan values")
    #     fpar_subdaily = fpar_subdaily.interpolate(limit=24).fillna(0)
